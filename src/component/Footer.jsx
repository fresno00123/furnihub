          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-[#272343] font-inter font-normal mb-4 max-w-[350px] mx-auto md:mx-0">
                FurniHub is your go-to destination for stylish, comfortable, and
                high-quality furniture. We bring together modern designs and
                timeless pieces to help you create spaces that feel both elegant
                and functional. At FurniHub, we focus on quality craftsmanship,
                fair pricing, and furniture that turns every house into a home.
              </p>
